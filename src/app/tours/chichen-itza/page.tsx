    ...
    <div className="min-h-screen bg-white">
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Tours a Chichén Itzá</h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            {destino?.descripcion || "Una de las Nuevas Siete Maravillas del Mundo."}
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tours.map((tour) => (
              <div key={tour.id} className="border border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-gradient-to-br from-amber-500 to-orange-700" />
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href={`/tours/chichen-itza/${tour.slug}`}
