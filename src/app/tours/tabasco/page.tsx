      ...
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Lugares Turísticos de Tabasco
          </h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            {destino?.descripcion ||
              "El Edén de México. Cacao, pantanos, cultura olmeca y naturaleza."}
          </p>
        </div>
      </section>
        ...
        {tours && tours.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tours.map((tour) => (
              ...
              >
                <div className="h-48 bg-gradient-to-br from-lime-500 to-green-700" />
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {tour.duracion && (
                        <p className="text-xs text-gray-500">{tour.duracion}</p>
                      )}
                    </div>
                    <Link
                      href={`/tours/tabasco/${tour.slug}`}
